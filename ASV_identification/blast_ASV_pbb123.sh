...
mkdir blast_results
blastn -query PBB123_asv_11182024.fasta -db nt -evalue 1e-30 -num_threads 8 -max_target_seqs 1 -outfmt '6 qseqid stitle evalue bitscore pident qcovs qcovhsp' -out blast_results/11182024_blast_pbb123.tsv
